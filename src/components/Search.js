...
const Search = ({ searchTerm, onChangeSearch, setStatus, status }) => {
  ...
  return (
    <Dropdown as={InputGroup} className="my-4  sticky-top shadow ">
      <FormControl
      ...
      >
        ...
        <Dropdown.Item className="electric-text-search">Electric</Dropdown.Item>
        <Dropdown.Item className="fairy-text-search">Fairy</Dropdown.Item>
        <Dropdown.Item className="fighting-text-search">Fighting</Dropdown.Item>
